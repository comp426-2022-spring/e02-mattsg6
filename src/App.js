...
function App() {
  ...
  const Add = (e) => {
    ...
    let currentQ00 = document.querySelector("#q00").value;
    let currentQ01 = document.querySelector("#q01").value;
    let currentQ02 = document.querySelector("#q02").value;
  ...
  return (
    <div className="App">
      ...
      <form>
        ...
        <br />
        <br />
        <input type="text" id="q00" placeholder="q00" />
        <br />
        <br />
        <input type="text" id="q01" placeholder="q01" />
        <br />
        <br />
        <input type="text" id="q02" placeholder="q02" />
        <br />
        <br />
        <input type="text" id="com" placeholder="Commits" />
        <br />
        <br />
        <input type="text" id="e01" placeholder="e01" />
        <br />
        <br />
